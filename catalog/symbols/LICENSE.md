# Vendored KiCad symbols — license summary

## kicad-official/

Symbols in this directory are vendored from the official KiCad symbol libraries.

- License: Creative Commons Attribution-ShareAlike 4.0 International (CC-BY-SA 4.0).
- Design exception: KiCad libraries license exception, maintained verbatim at https://www.kicad.org/libraries/license/.
...
- SnapEDA files vendored (with this PR merged): 3 of 3 planned (3 of 10 allowed by SnapEDA).
